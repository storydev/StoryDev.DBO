...
namespace StoryDev.DBO.PostgreSQL
{
    public class DBReader : IDBReader
    {
        ...
        public DBReader(OracleDataReader reader)
        {
            this.reader = reader;
        }
        ...
        {
            short value = reader.GetInt16(GetOrdinal(column));
            if (value < 0)
                value = 0;
            return (ushort)value;
        }
        ...
        {
            int value = reader.GetInt32(GetOrdinal(column));
            if (value < 0)
                value = 0;
            return (uint)value;
        }
        ...
        {
            long value = reader.GetInt64(GetOrdinal(column));
            if (value < 0L)
                value = 0L;
            return (ulong)value;
        }
